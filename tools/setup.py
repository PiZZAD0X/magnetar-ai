...
def main():
  ...
  This script will create your MAI dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your MAI project folder:
    [Arma 3 installation directory]\\{} => MAI project folder
    P:\\{}                              => MAI project folder
